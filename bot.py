...
#     For local  → paste values directly here
# ══════════════════════════════════════════════════════
...
if TELEGRAM_TOKEN == "YOUR_TELEGRAM_BOT_TOKEN":
    sys.exit("❌  TELEGRAM_TOKEN is not set. Add it as an environment variable or paste it in bot.py")
if GROQ_API_KEY == "YOUR_GROQ_API_KEY":
    sys.exit("❌  GROQ_API_KEY is not set. Add it as an environment variable or paste it in bot.py")
